...
static ConVar	cl_clean_textures_on_death("cl_clean_textures_on_death", "0", FCVAR_CHEAT, "If enabled, attempts to purge unused textures every time a freeze cam is shown");
