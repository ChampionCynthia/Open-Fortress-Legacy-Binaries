...
//
//-----------------------------------------------------------------------------
ConVar tf_allow_server_hibernation( "tf_allow_server_hibernation", "0", FCVAR_NONE, "Allow the server to hibernate when empty." );

// ficool2 - This is only so we can control hibernation in the engine for servers
class COFCGCLobby : public IServerGCLobby
{
public:
/*
...
*/
	...
	virtual void UpdateServerDetails(void) override									{ }
	virtual bool ShouldHibernate() override											{ return tf_allow_server_hibernation.GetBool(); }
};
